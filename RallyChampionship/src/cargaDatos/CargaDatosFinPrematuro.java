...
public class CargaDatosFinPrematuro {
	public CargaDatosFinPrematuro() {
		...
		Organizacion org = Organizacion.getInstance(1, 3, Collections.reverseOrder(new ComplejidadComparator()));
		...
		Escuderia escuderiaPeugeot = new EscuderiaReal("PEUGEOT",est2);
		...
		Escuderia escuderiaSeat = new EscuderiaReal("SEAT",est2);
